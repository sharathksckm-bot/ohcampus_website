(function(){
  ...
  function enhanceHero(){
    ...
    var statsDiv=document.createElement("div");statsDiv.id="ohcHeroStats";statsDiv.className="ohc-hero-stats";statsDiv.innerHTML='<a href="/allCollegeList" class="ohc-hero-stat"><i class="fas fa-university ohc-hero-stat-icon"></i><span class="ohc-hero-stat-num">10,616</span><span class="ohc-hero-stat-label">Colleges</span></a><a href="/allCollegeList/course/bycat/2" class="ohc-hero-stat"><i class="fas fa-book-open ohc-hero-stat-icon"></i><span class="ohc-hero-stat-num">6,303</span><span class="ohc-hero-stat-label">Courses</span></a><a href="/exams" class="ohc-hero-stat"><i class="fas fa-file-alt ohc-hero-stat-icon"></i><span class="ohc-hero-stat-num">201</span><span class="ohc-hero-stat-label">Exams</span></a>';textset.appendChild(statsDiv);

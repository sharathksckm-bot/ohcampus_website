...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.navigation = [{ id: 'home', title: 'Home', type: 'basic', link: '/home' },
        { id: 'engineering', title: 'Engineering', type: 'basic' },
        { id: 'management', title: 'Management', type: 'basic' },
        { id: 'medicine', title: 'Medicine & Health Sciences', type: 'basic' },
        { id: 'nursing', title: 'Nursing', type: 'basic' },
        { id: 'pharmacy', title: 'Pharmacy', type: 'basic' },
        { id: 'dental', title: 'Dental', type: 'basic' },
        { id: 'science', title: 'Science', type: 'basic' },
        { id: 'hotel', title: 'Hotel management', type: 'basic' },
        { id: 'medical', title: 'Para Medical', type: 'basic' },
        { id: 'more', title: 'More', type: 'basic' },
        ];
    ...
    getdatta() {
        this.CompareclgService.getCategoryForMenuNav().subscribe(res => {
            console.log(res);
            this.navigation = res.horizontal;
            // console.log(this.navigation);

            // this.categoryArrMore = this.categoryArr.slice(3);

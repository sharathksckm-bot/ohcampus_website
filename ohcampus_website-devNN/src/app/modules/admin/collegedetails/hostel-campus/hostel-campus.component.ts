...
export class HostelCampusComponent implements OnInit {
 // @Input() blogsdescription: string = '';
  ...
  getHostelDetailsByClgId() {
    this.CompareclgService.getHostelDetailsByClgId(this.hostelId).subscribe(async res => {
      // console.log(res);
      this.hostelTitle = res.response_data.name;
      this.hostelDescription = res.response_data.description;
      this.hostelImage = res.response_data.imagepath;
      this.created_date = res.response_data.created_date;
      this.updated_date = res.response_data.updated_date;

      console.log(this.hostelTitle+"\n"+this.hostelDescription+"\n"+this.hostelImage+"\n"+this.created_date+"\n"+this.updated_date)
      // try {
